...
def main() -> None:
    parser = argparse.ArgumentParser(description="Single-run test-eval wrapper for the graph-event baseline.")
    ...
    print(f"[test-eval] running graph-event baseline in {args.output_dir}")
