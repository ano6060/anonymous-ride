...
def suggest_hparams(trial: optuna.Trial, args: argparse.Namespace) -> dict[str, int | float]:
    return suggest_hparams_from_search_space(
        ...
        required_keys=TRANSFORMER_TRAIN_HPARAM_KEYS,
    )
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Optuna worker for Transformer hyperparameter optimization. "
